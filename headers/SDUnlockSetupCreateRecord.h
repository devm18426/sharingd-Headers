...
@property (nonatomic,readonly) char hasPairedDeviceID; 
@property (nonatomic,retain) NSString * pairedDeviceID;              //@synthesize pairedDeviceID=_pairedDeviceID - In the implementation block
...
-(void)setPairedDeviceID:(NSString *)arg1 ;
-(char)hasPairedDeviceID;
@end
